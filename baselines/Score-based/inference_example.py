...
if __name__ == '__main__':
    subsets_multidog = ['bichon_frise','chinese_rural_dog','golden_retriever','labrador_retriever','teddy']
    root_general = '/home/tri/multi-level-anomaly/data/class-based/example/'
    for subset in subsets_multidog:
        # root = root_general + f'{subset}' + '/test/'
        root = root_general
        path_test_data = '/home/tri/multi-level-anomaly/data/template/' + f'example_{subset}' + '_template.csv' 
        ...
        df.to_csv('/home/tri/llms-anomaly-detection/new/Anomaly-Detection-using-Score-based-Perturbation-Resilience/results/score-based' + 'example' + '_' + subset +'.csv', index=False)

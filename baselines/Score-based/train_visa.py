...
def run():
    ...
    class_names = ['capsules/train/good', 'chewinggum/train/good', 'fryum/train/good', 'macaroni1/train/good', 'macaroni2/train/good', 'pcb1/train/good', 'pcb2/train/good', 'pcb3/train/good', 'pipe_fryum/train/good']

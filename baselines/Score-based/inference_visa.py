...
if __name__ == '__main__':
    ...
    root_general = '/home/tri/multi-level-anomaly/data/area-based/VisA_reorganized/'
    ...
    for subset in subsets_visa:
        ...
        root = root_general + f'{subset}' + '/test/'
        sums, maxs, paths, levels = inference(class_name=subset, path_test_data=path_test_data, root=root)
        df = pd.DataFrame({
            'Path': paths,
            'Area': levels,
            'Anomaly Score': maxs,
        ...
        df.to_csv('/home/tri/llms-anomaly-detection/new/Anomaly-Detection-using-Score-based-Perturbation-Resilience/results/score-based' + 'visa' + '_' + subset +'.csv', index=False)

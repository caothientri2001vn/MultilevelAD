...
from utils.data.load_data import Train_Dataloader, Test_Dataloader, Custom_Test_Dataloader, Distribution_Train_Dataloader, Coor_Distribution_Train_Dataloader
from utils.learning.train_part import Coreset, Distribution, Custom_AC_Model, Coor_Distribution
...
if __name__ == '__main__':
    ...
    train_dataloader, test_dataloader = Train_Dataloader(args), Custom_Test_Dataloader(args)
    ...
    ac_model = Custom_AC_Model(args, dist_input_size, dist_output_size)

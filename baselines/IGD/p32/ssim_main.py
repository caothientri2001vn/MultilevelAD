...
def train(args, NORMAL_NUM, generator, discriminator, optimizer_g, optimizer_d):
    ...
    test_auc = 0
    BEST_AUC = 0
    train_path = '/home/tri/multi-level-anomaly/data/area-based/mvtec_order/{}/train/good'.format(NORMAL_NUM)
    START_ITER = 0
...
if __name__ == "__main__":
    ...
    for key in sorted(sub_category):
        ...
        train_path = '/home/tri/multi-level-anomaly/data/area-based/mvtec_order/{}/train/'.format(NORMAL_NUM)
        test_root = '/home/tri/multi-level-anomaly/data/area-based/mvtec_order/{}/test/'.format(NORMAL_NUM)
        gt_root = '/home/tri/multi-level-anomaly/data/area-based/mvtec_order/{}/ground_truth/'.format(NORMAL_NUM)

...
def get_args():
    ...
    parser.add_argument('--dataset_name', default = 'skin-lesion', type=str)
...
def train(pars):
    ...
    train_path = f'.../data/Medical/{pars.dataset_name}/level_0_train'
    
    save_model_path  = f'./checkpoint/{pars.dataset_name}/wres50_{pars.dataset_name}.pth'
    ...
    for epoch in tqdm(range(1,num_epoch+1)):
        ...
        if epoch%50 == 0 or epoch == 1: 
            torch.save({'proj': proj_layer.state_dict(),
                        ...
                        'bn':bn.state_dict()}, save_model_path.replace('.pth', '_'+str(epoch)+'.pth'))

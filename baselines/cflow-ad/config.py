...
def get_args():
    ...
    # My args
    parser.add_argument('--save-frequency', default=6, type=int,
                        help='save frequency for meta epoch')
    parser.add_argument('--ood', action='store_true', default=False,
                        help='out-of-distribution, for loading the dataset from csv, and store ood score to csv file')
    parser.add_argument('--ood-noise-type', default='', type=str,
                        help='video file path')

...
class Options():
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--testroot', default='', help='path to testset')
        self.parser.add_argument('--in_file', default='', help='path to the input file.')
        self.parser.add_argument('--out_file', default='', help='path to the output file.')

...
INPUT_FILE_NAME="test_input_files_skin_32px.txt"
MODEL_DATA_DIR="./data_skin_32px"
MODEL_OUTPUT_DIR="./output_skin_32px/"
DATASETS=("skin")
...
OUTPUT_FILE_NAME="csv_rerun/ocr-gan-32px_${DATASET_NAME}-lesion.csv"
...
python csv_to_txt.py "$DATASET_DIR/${DATASET_NAME}-lesion_template.csv" "$INPUT_FILE_NAME"
...
python merge_csv.py "$DATASET_DIR/${DATASET_NAME}-lesion_template.csv" "$OUTPUT_FILE_NAME" "merged_$OUTPUT_FILE_NAME"
done
